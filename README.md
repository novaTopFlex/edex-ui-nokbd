...
## Credits
(The original) eDEX-UI's source code was primarily written by [Squared](https://github.com/GitSquared). If you want to get in touch with me or find other projects I'm involved in, check out [the website](https://gaby.dev). The nokbd version optimized for the desktop was modified as necessary per the open-source philosophy by [novaTopFlex](https://github.com/novaTopFlex).
